...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#F3F3F3] w-full pt-8 md:pt-16 pb-16 md:pb-28 border-t border-zinc-300 px-4 md:px-6">
      <div className="md:px-10">
        ...
        {/* Desktop Grid Layout */}
        <div className="hidden md:grid grid-cols-6 gap-8 text-xs text-black">
        ...
        {/* Desktop Copyright */}
        <div className="hidden md:flex mt-24 items-center font-extrabold tracking-wide justify-between text-xs text-black">
          <span>©2025 Serge DeNimes. All Rights Reserved.</span>
        </div>
      </div>
    </footer>
