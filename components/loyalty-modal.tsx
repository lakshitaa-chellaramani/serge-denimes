...
export default function LoyaltyModal({ onClose }: LoyaltyModalProps) {
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center source-sans-3 z-50 p-4">
      <div className="bg-white rounded-lg w-full max-w-3xl min-h-[600px]">
        {/* Header */}
        <div className="relative bg-black text-white text-center py-4 rounded-t-lg">
          <h2 className="text-2xl">Introducing Loyalty Scheme</h2>
          <button
            onClick={onClose}
