export default function HallmarkSection() {
  return (
    <section className="bg-white text-center py-12">
      {/* Heading */}
        <h2 className="text-lg px-4 lg:px-0 md:text-2xl font-serif font-thin leading-relaxed pt-10 font-times-new-roman">
          Every piece is made from 925 Sterling Silver,<br className="hidden lg:block" />
          designed in London and hallmarked at the <br className="hidden lg:block" />
